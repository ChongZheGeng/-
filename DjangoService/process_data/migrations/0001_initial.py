    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "part_number",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="构件编号"
                    ),
                ),
                (
                    "material_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="参数编码"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tool_spec",
                    models.CharField(max_length=100, verbose_name="刀具规格"),
                ),
                (
                    "initial_wear_threshold",
                    models.FloatField(verbose_name="初始磨损阈值"),
                ),
                (
                    "current_status",
                    models.CharField(
                ...
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="刀具编码"
                    ),
                ),
                (
                    "description",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="process_data.processcategory",
                        verbose_name="父分类",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="任务编码"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "duration",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="预计持续时间(分钟)"
                    ),
                ),
                (
                    "actual_duration",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="实际持续时间(分钟)"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="process_data.compositematerial",
                        verbose_name="复合材料构件",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(verbose_name="尺寸公差(mm)"),
                ),
                (
                    "defect_type",
                    models.CharField(
                ...
                ("inspector", models.CharField(max_length=50, verbose_name="检验员")),
                (
                    "images",
                    models.TextField(blank=True, null=True, verbose_name="图像路径"),
                ),
                (
                    "remarks",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="process_data.processingtask",
                        verbose_name="加工任务",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("spindle_speed", models.IntegerField(verbose_name="主轴转速(rpm)")),
                ("feed_rate", models.FloatField(verbose_name="进给速度(mm/min)")),
                ("cutting_depth", models.FloatField(verbose_name="切削深度(mm)")),
                (
                    "coolant_type",
                    models.CharField(
                        choices=[
                ...
                (
                    "additional_params",
                    models.JSONField(blank=True, null=True, verbose_name="附加参数"),
                ),
                (
                    "processing_task",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="模板编码"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="数据编码"
                    ),
                ),
                ("name", models.CharField(max_length=100, verbose_name="数据名称")),
                (
                    "batch_number",
                    models.CharField(max_length=100, verbose_name="批次号"),
                ),
                ("operator", models.CharField(max_length=50, verbose_name="操作员")),
                (
                    "remark",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="process_data.processtemplate",
                        verbose_name="工艺模板",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sensor_id",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="传感器ID"
                    ),
                ),
                (
                    "processing_task",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="process_data.processparameter",
                        verbose_name="工艺参数",
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="process_data.TemplateParameter",
                to="process_data.processparameter",
                verbose_name="工艺参数",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "measurement_method",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="测量方法"
                    ),
                ),
                (
                    "position",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="测量位置"
                    ),
                ),
                (
                    "images",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tool_wear_records",
                        to="process_data.processingtask",
                        verbose_name="加工任务",
                    ),
                ),
